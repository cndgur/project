	                                ...
	                                <tr>
	                                    <td>
	                                        <div class="container">
	                                            ...
	                                            추가정보<br>
	                                            <%=ro.getrInfo() %>
	                                            <button id="reviewbt" type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#update-pwd-modal">예약하기</button>
	                                        </div>
	                                    </td>  
	                                </tr>
	                            </table>
						                    ...
						                    <div class="modal-body" align="center">
						                        <form action="hotel.booking" method="POST">
						                        	<input type="hidden" name="hotel" value="<%=h.gethName() %>">
						                        	<div>
						                        		<h3><%=h.gethName() %></h3><br>
